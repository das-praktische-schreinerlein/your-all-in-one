...
## Changelog for release: feature-YAIO2893-improvements-201702-RELEASE
- **YaioApp (YAIO2917)**
  - **GUI (YAIO2918)**
    - add a shortcut-button to set desc to be autogenerated by server (url, file) (YAIO2969) 
    - add toolbar with layout-shortcuts for ymf (YAIO2968) 
  - **Admin/Doku-Funktionen (YAIO2921)**
    - development webserver via grunt (YAIO2967) 
- **YaioServer (YAIO2923)**
  - **Code-Verbesserungen (YAIO2925)**
      - Code-Refactoring: fixed codestyle-issues (Override, Overloading fields, imports) (YAIO2996) 
- **Yaio-CI-Server (YAIO2970)**
  - docker start simple http-server (YAIO2971) 
  - CI-Server: use docker-selenium-hub with ff,chrome,phantomjs-node (YAIO2995) 
