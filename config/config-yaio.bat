...
set CP="%BASEPATH%..\target\yaio-0.1.0.BUILD-SNAPSHOT-jar-with-dependencies.jar;%BASEPATH%..\lib\poi-extended.jar;%BASEPATH%..\lib\commons-cli-1.2.jar;%BASEPATH%..\target\classes"
