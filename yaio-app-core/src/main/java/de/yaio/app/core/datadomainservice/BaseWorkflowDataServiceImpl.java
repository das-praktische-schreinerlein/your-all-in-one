...
//            planChildrenSumData.setPlanChildrenSumEnde(planCalcData.getPlanCalcEnde());
    ...
    public Date getCalcedDateFromPredecessor(final BaseWorkflowData baseNode, final boolean flgStart) {
        ...
        if (baseNode.getPlanPredecessorDependencieType() == PlanDependencieData.PredecessorDependencieType.NO) {
            // no dependency
            return null;
        }
        
        // get date for dependencieType
        if (baseNode.getPlanPredecessorDependencieType() == PlanDependencieData.PredecessorDependencieType.inherit) {
            // inherit the dates
            if (flgStart) {
        ...
        } else if (baseNode.getPlanPredecessorDependencieType() == PlanDependencieData.PredecessorDependencieType.EndEnd) {
            // myEnd = yourEnd
            if (flgStart) {
        ...
        } else if (baseNode.getPlanPredecessorDependencieType() == PlanDependencieData.PredecessorDependencieType.EndStart) {
            // myStart = yourEnd
            if (flgStart) {
                // start = yourEnd
                date = predecessor.getPlanCalcEnde();
        ...
        } else if (baseNode.getPlanPredecessorDependencieType() == PlanDependencieData.PredecessorDependencieType.StartStart) {
            // myStart = yourStart
            if (flgStart) {
                // start = yourStart
                date = predecessor.getPlanCalcStart();
