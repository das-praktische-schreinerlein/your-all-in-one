...
privileged aspect BaseNode_Roo_JavaBean {
    ...
    public PlanDependencieData.DurationMeasure BaseNode.getPlanDurationMeasure() {
        return this.planDurationMeasure;
    }
    
    public void BaseNode.setPlanDurationMeasure(PlanDependencieData.DurationMeasure planDurationMeasure) {
        this.planDurationMeasure = planDurationMeasure;
    }
    
    public PlanDependencieData.PredecessorType BaseNode.getPlanPredecessorType() {
        return this.planPredecessorType;
    }
    
    public void BaseNode.setPlanPredecessorType(PlanDependencieData.PredecessorType planPredecessorType) {
    ...
    public PlanDependencieData.PredecessorDependencieType BaseNode.getPlanPredecessorDependencieType() {
        return this.planPredecessorDependencieType;
    }
    
    public void BaseNode.setPlanPredecessorDependencieType(PlanDependencieData.PredecessorDependencieType planPredecessorDependencieType) {
    ...
    public PlanDependencieData.DurationMeasure BaseNode.getPlanPredecessorShiftMeasure() {
        return this.planPredecessorShiftMeasure;
    }
    
    public void BaseNode.setPlanPredecessorShiftMeasure(PlanDependencieData.DurationMeasure planPredecessorShiftMeasure) {
