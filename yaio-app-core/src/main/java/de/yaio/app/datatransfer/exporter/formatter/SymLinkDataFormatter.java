...
/** 
 * interface with service-functions for formatting of dataDomain: SymLinkData
 * 
 ...
 * @license                      http://mozilla.org/MPL/2.0/ Mozilla Public License 2.0
 */
public interface SymLinkDataFormatter extends Formatter {
     ...
     */
    void formatSymLinkData(SymLinkData node, StringBuffer nodeOutput, OutputOptions options);
}
