        ...
        $(treeId).fancytree({
            ...
            onExpandCallBack: function (node, flag) {
                ...
                if (flag) {
                    ...
                    yaioAppBase.get('YaioExplorerTreeService').yaioActivateGanttBlock(node, true);
                } else {
                    // I'm collapsed: show me and my childsum
                    console.debug("onExpandCallBack: activate gantt - sum data of me+children for " + node.key);
                    yaioAppBase.get('YaioExplorerTreeService').yaioActivateGanttBlock(node, false);
                }
            },
            ...
            dnd: {
                ...
                dragDrop: function(node, data) {
                    if (window.confirm("Wollen Sie die Node wirklich verschieben?")) {
                        ...
                        yaioAppBase.get('YaioExplorerTreeService').yaioMoveNode(data.otherNode, newParentKey, newPos);
                        return true;
                    } else {
                        // discard
                        return false;
            ...
            edit: {
                ...
                save: function(event, data){
                    ...
                    if (window.confirm("Wollen Sie den Titel wirklich ändern?")) {
                        ...
                        yaioAppBase.get('YaioExplorerTreeService').yaioSaveNode(data);
    ...
    **/
            ...
            switch( data.cmd ) {
                ...
                case "indent":
                    if (window.confirm("Wollen Sie die Node wirklich verschieben?")) {
                        ...
                        // move yaioNode
                        yaioAppBase.get('YaioExplorerTreeService').yaioMoveNode(node, newParentKey, 9999);
                        return true;
                    } else {
                        // discard
                        return false;
                ...
                case "moveUp":
                    ...
                    yaioAppBase.get('YaioExplorerTreeService').yaioMoveNode(node, newParentKey, newPos);
                    break;
                case "moveDown":
                    // check parent
                    var newParent = node.getParent();
                    ...
                    break;
                case "remove":
                    yaioAppBase.get('YaioExplorerTreeService').yaioRemoveNodeById(node.key);
                    break;
                case "addChild":
                    yaioAppBase.get('YaioEditorService').yaioOpenNodeEditor(node.key, 'create');
                    break;
                case "asTxt":
                    yaioAppBase.get('YaioExplorerTreeService').openTxtExportWindow($('#container_content_desc_' + node.key).text());
                    break;
                case "asJira":
                    yaioAppBase.get('YaioExplorerTreeService').openJiraExportWindow(node.key);
                    break;
                case "focus":
    ...
    me.renderDataBlock = function(basenode, fancynode) {
        ...
        if (basenode.className == "TaskNode" || basenode.className == "EventNode") {
            ...
            yaioAppBase.get('YaioExplorerTreeService').yaioLoadSymLinkData(basenode, fancynode);
        } 
    ...
    me.createGanttBlock = function(basenode, type, addStyle, label) {
        ...
        // fill gantt
        yaioAppBase.get('YaioExplorerTreeService').fillGanttBlock(basenode, type, label, $divLine);
    ...
    me.renderGanttBlock = function(basenode, fancynode) {
        ...
        if (basenode.className == "TaskNode" || basenode.className == "EventNode") {
            ...
            // create plan
            $div = yaioAppBase.get('YaioExplorerTreeService').createGanttBlock(basenode, "plan", statestyle, "Plan");
            $row.append($div);
            $div = yaioAppBase.get('YaioExplorerTreeService').createGanttBlock(basenode, "planChildrenSum", statestyle, "PlanSum");
            $row.append($div);
            
            // create isst and add stytestyle
            $div = yaioAppBase.get('YaioExplorerTreeService').createGanttBlock(basenode, "ist", statestyle, "Ist");
            $row.append($div);
            $div = yaioAppBase.get('YaioExplorerTreeService').createGanttBlock(basenode, "istChildrenSum", statestyle, "IstSum");
            $row.append($div);
        } else {
    ...
    me.renderColumnsForNode = function(event, data, preventActionsColum) {
        ...
        if (! preventActionsColum) {
            $tdList.eq(colActions).html(
                    ...
                    + "<a onclick=\"javascript: yaioAppBase.get('YaioExplorerTreeService').yaioRemoveNodeById('" + basenode.sysUID + "'); return false;\""
        ...
        // render datablock
        var $nodeDataBlock = yaioAppBase.get('YaioExplorerTreeService').renderDataBlock(basenode, node);
        ...
        //        + "<span lang='tech'>Markdown</span>"
                ;
            commands += "<a class=\"button command-desc-jiraexport\" onClick=\"yaioAppBase.get('YaioExplorerTreeService').openJiraExportWindow('"+ basenode.sysUID + "'); return false;" 
                +   "\" lang='tech' data-tooltip='tooltip.command.OpenJiraExportWindow'>common.command.OpenJiraExportWindow</a>";
            commands += "<a class=\"button command-desc-txtexport\" onClick=\"yaioAppBase.get('YaioExplorerTreeService').openTxtExportWindow(" 
        ...
        // add gantt
        var $nodeGanttBlock = yaioAppBase.get('YaioExplorerTreeService').renderGanttBlock(basenode, node);
        ...
        // calc nodeData
        yaioAppBase.get('YaioExplorerTreeService').yaioRecalcMasterGanttBlockFromTree();
    }
     ...
     *     calls yaioRecalcGanttBlock for every node and afterwards yaioAppBase.get('YaioExplorerTreeService').yaioRecalcMasterGanttBlockFromTree()
     * <h4>FeatureResult:</h4>
     *   <ul>
     *     <li>Updates DOM
     *   </ul> 
    ...
    me.yaioRecalcFancytreeGanttBlocks = function() {
        if ($("#tree").length > 0) {
            ...
            $("#tree").fancytree("getRootNode").visit(function(node){
                yaioAppBase.get('YaioExplorerTreeService').yaioRecalcGanttBlock(node.data.basenode);
            });
        }
        yaioAppBase.get('YaioExplorerTreeService').yaioRecalcMasterGanttBlockFromTree()
    }
    ...
    me.yaioRecalcMasterGanttBlock = function(basenode) {
        ...
        yaioAppBase.get('YaioExplorerTreeService').yaioRecalcGanttBlock(basenode);
    ...
    me.yaioRecalcMasterGanttBlockFromTree = function() {
        ...
        if (masterNodeId != undefined) {
            ...
            yaioAppBase.get('YaioExplorerTreeService').yaioRecalcMasterGanttBlockLine(masterNodeId, "plan");
            yaioAppBase.get('YaioExplorerTreeService').yaioRecalcMasterGanttBlockLine(masterNodeId, "ist");
        } else {
    ...
    me.yaioRecalcGanttBlock = function(basenode) {
        yaioAppBase.get('YaioExplorerTreeService').fillGanttBlock(basenode, "plan", "Plan", null);
        yaioAppBase.get('YaioExplorerTreeService').fillGanttBlock(basenode, "planChildrenSum", "PlanSum", null);
        yaioAppBase.get('YaioExplorerTreeService').fillGanttBlock(basenode, "ist", "Ist", null);
        yaioAppBase.get('YaioExplorerTreeService').fillGanttBlock(basenode, "istChildrenSum", "IstSum", null);
    }
    ...
    me.openNodeHierarchyForNodeId = function(treeId, activeNodeId) {
        ...
        // open Hierarchy
        yaioAppBase.get('YaioExplorerTreeService').openNodeHierarchy(treeId, lstIdsHierarchy);
    }
    ...
    me.yaioMoveNode = function(node, newParentKey, newPos) {
        ...
        yaioAppBase.get('YaioExplorerTreeService').yaioDoUpdateNode(node, url, json);
    }
    ...
    me.yaioRemoveNodeById = function(nodeId) {
        if (window.confirm("Wollen Sie die Node wirklich l&ouml;schen?")) {
            ...
            yaioAppBase.get('YaioExplorerTreeService').yaioDoRemoveNode(treeNode, url);
        } else {
            // discard
            return false;
        }
                ...
                if (response.state == "OK") {
                    ...
                    if (response.parentIdHierarchy && response.parentIdHierarchy.length > 0) {
                        ...
                        tree.reload().done(function(){
                            ...
                            yaioAppBase.get('YaioExplorerTreeService').openNodeHierarchy("#tree", response.parentIdHierarchy);
                        });
                    } else {
        ...
        $.ajax({
            ...
            success : function(response, textStatus, jqXhr) {
                ...
                if (response.state == "OK") {
                    ...
                    if (response.node) {
                        var $nodeDataBlock = yaioAppBase.get('YaioExplorerTreeService').renderDataBlock(response.node, fancynode);
