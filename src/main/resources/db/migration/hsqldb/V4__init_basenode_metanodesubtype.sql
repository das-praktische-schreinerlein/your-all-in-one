...
where
  (META_NODE_SUB_TYPE is null or META_NODE_SUB_TYPE = '') and
...
where
  ...
  (NAME like '%urzfristige Projekte%' or NAME like '%urzfristige Aufgaben%' or NAME like '%urzfristige Pläne%' or
   NAME like '%aufende Projekte%' or NAME like '%aufende Aufgaben%' or NAME like '%aufende Pläne%' or
   NAME like 'Planung' or NAME like '%eplante Projekte%')
;
--------- backlog
...
;
--------- archiv
update BASE_NODE set META_NODE_SUB_TYPE='TaskNodeMetaNodeSubType.ARCHIV'
where
  (META_NODE_SUB_TYPE is null or META_NODE_SUB_TYPE = '') and
  DTYPE in ('TaskNode') and
  (NAME like '%ledigte Projekte%' or NAME like '%ledigte Aufgaben%' or NAME like '%ledigte Pläne%' or
   NAME like '%ledigte ToDos%'or NAME like '%mgesetzte ToDos%')
;
---- project
