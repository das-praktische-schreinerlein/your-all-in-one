...
public class CachedDataRecalcer {
    ...
    public String recalcCachedData() throws Exception {
        ...
        TypedQuery<BaseNode> query = BaseNode.entityManager().createQuery("SELECT o FROM BaseNode o where cachedParentHierarchy is null order by ebene asc", BaseNode.class);
