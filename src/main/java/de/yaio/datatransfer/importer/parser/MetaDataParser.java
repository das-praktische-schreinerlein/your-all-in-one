 ...
 *     import
 * <h4>FeatureDescription:</h4>
 *     interface with service-functions for parsing of dataDomain: MetaData
 * 
 * @package de.yaio.datatransfer.importer.parser
 * @author Michael Schreiner <michael.schreiner@your-it-fellow.de>
 * @category collaboration
 ...
 * @license http://mozilla.org/MPL/2.0/ Mozilla Public License 2.0
 */
public interface MetaDataParser extends Parser {
     ...
     *     <li>updates memberVariable node.meta* - found Pattern are set at MemberVars of the DataDomain
     *   </ul> 
