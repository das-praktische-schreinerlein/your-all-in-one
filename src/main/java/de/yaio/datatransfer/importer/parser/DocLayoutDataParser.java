...
/** 
 * interface with service-functions for parsing of dataDomain: DocLayoutData
 * 
 ...
 * @license                      http://mozilla.org/MPL/2.0/ Mozilla Public License 2.0
 */
public interface DocLayoutDataParser extends Parser {

    /** 
     * parses DataDomain: DocLayoutData from the nodename
     ...
     * @FeatureResult                updates memberVariable node.docLayout* - found Pattern are set at MemberVars of the DataDomain
