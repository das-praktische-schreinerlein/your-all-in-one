...
/** 
 * interface with service-functions for formatting of dataDomain: PlanData
 * 
 ...
 * @license                      http://mozilla.org/MPL/2.0/ Mozilla Public License 2.0
 */
public interface PlanDataFormatter extends Formatter {

    /** 
     * formats DomainData: PlanData and appends output to StringBuffer nodeOutput
     * @FeatureConditions            formatter runs only if options.flgShowPlan is set<br> show brackets if options.flgShowBrackets is set<br> fill with whitespace to options.intendFuncArea
     * @FeatureDomain                Praesentation
