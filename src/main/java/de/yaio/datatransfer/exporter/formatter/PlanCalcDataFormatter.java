...
public interface PlanCalcDataFormatter extends Formatter {
     ...
     * @FeatureConditions            formatter runs only if options.flgShowCalc is set<br> show brackets if options.flgShowBrackets is set<br> fill with whitespace to options.intendFuncArea
     * @FeatureDomain                Praesentation
