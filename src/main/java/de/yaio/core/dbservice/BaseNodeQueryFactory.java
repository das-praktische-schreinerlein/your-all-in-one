...
public class BaseNodeQueryFactory {
    ...
    /**
     * create query to calc the effort (planned or ist) for all tasks matching the filter between start/end and return
    ...
    /**
     * create a query to read count of planned/real tasks for all tasks matching the filter between start/end and return
     * a record with date and count of tasks on this date
