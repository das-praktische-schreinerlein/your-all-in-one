...
rem     imports files from fileimportqueue to running yaio-app
rem <h4>Syntax:</h4>
rem     PROG REPEATEVERYSECONDS
rem <h4>Example:</h4>
rem     cd D:\public_projects\yaio\yaio
rem     sbin\importFilesFromFileImportQueueToYAIOApp.bat
rem 
rem @package de.yaio
...
:startloop
set CMD=call %YAIOSCRIPTPATH%\importFilesFromFolderToYAIOApp.bat file %YAIOSCRIPTPATH%\..\queues\fileimportqueue\ DELETE
echo %CMD%
%CMD%
