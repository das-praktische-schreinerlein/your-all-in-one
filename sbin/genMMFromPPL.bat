...
set CMD=java %JAVAOPTIONS% -cp %CP% %PROG_MM% -m %PROJNAME% %OUTPUT_OPTIONS% %MMPATH%%SRCFILE%.ppl
echo "create MM from PPL: %PROG_MM% -m %PROJNAME% %OUTPUT_OPTIONS% %MMPATH%%SRCFILE%.ppl > %MMPATH%\%SRCFILE%.mm"
rem echo %CMD%
