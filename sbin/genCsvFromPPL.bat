...
set CMD=java %JAVAOPTIONS% -cp %CP% %PROG_CSVN% -m %PROJNAME% %OUTPUT_OPTIONS% %MMPATH%%SRCFILE%.ppl
echo "create CSV from PPL: %PROG_CSVN% -m %PROJNAME% %OUTPUT_OPTIONS% %MMPATH%%SRCFILE%.ppl > %MMPATH%\%SRCFILE%.tab"
rem echo %CMD%
